...
**Total tracked files: 2975.**

| Category | Files | % |
|---|---|---|
| documented | 2729 | 91.7% |
| doc | 95 | 3.2% |
| static-asset | 71 | 2.4% |
| supporting | 63 | 2.1% |
| excluded | 17 | 0.6% |
...
| `docs/liftor-rebuild` | 29 | This rebuild manual |
...
| `scripts/check-rebuild-manual-consistency.mjs` | 1 | Technical Manual P/S — repository scripts |
