...
export const BT_NAV = [
  { to: "/founder/business-templates", label: "Overview" },
  { to: "/founder/business-templates/library", label: "Library" },
  { to: "/founder/business-templates/apply", label: "Apply" },
  { to: "/founder/business-templates/business-setup", label: "Business setup" },
  { to: "/founder/business-templates/settings", label: "Settings" },
];

export function BTLayout({ title, subtitle, children, actions }: { title: string; subtitle?: string; children: ReactNode; actions?: ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <span>Business Template Factory</span>
        </div>
...
export function BTSection({ title, description, children, actions }: { title: string; description?: string; children: ReactNode; actions?: ReactNode }) {
  return (
    <Card className="tech-card">
...
export function BTStat({ label, value, hint }: { label: string; value: ReactNode; hint?: string }) {
  return (
    <Card className="tech-card">
