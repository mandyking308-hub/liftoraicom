...
export const WD_NAV = [
  { to: "/founder/business-wind-down",                       label: "Overview" },
  { to: "/founder/business-wind-down/pause",                 label: "Pause / Park" },
  { to: "/founder/business-wind-down/closure-checklist",     label: "Closure checklist" },
  { to: "/founder/business-wind-down/customer-offboarding",  label: "Customer offboarding" },
  { to: "/founder/business-wind-down/vendor-cancellation",   label: "Vendor cancellation" },
  { to: "/founder/business-wind-down/data-retention",        label: "Data / retention" },
  { to: "/founder/business-wind-down/archive",               label: "Archive" },
];

export function WdLayout({ title, subtitle, children }: { title: string; subtitle?: string; children: ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span><span>Business Wind-Down</span>
        </div>
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            <PowerOff size={20} className="text-primary" />
            {title}
            ...
            <Badge variant="outline" className="bg-yellow-500/15 text-yellow-300 border-yellow-500/30 text-[10px]">
              <ShieldAlert size={9} className="mr-1" /> All closures/notices approval-gated
            </Badge>
          </h1>
