...
} from "@/components/founder/social-relationships/SocialRelationshipPanels";
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Founder-controlled networking, conversations and relationship building. Separate from{" "}
              <Link className="underline" to="/founder/social-autopilot">Social Autopilot</Link> publishing.
            </p>
          </div>
          <div className="w-72">
            <Label className="text-[11px]">Active business ID</Label>
            <Input value={businessId} onChange={(e) => setBusinessId(e.target.value.trim())} placeholder="business_id" />
          </div>
        </div>
        ...
        <Tabs value={tab} onValueChange={setTab}>
          <TabsList className="flex flex-wrap h-auto">
            ...
            <TabsTrigger value="targets">Target lists</TabsTrigger>
          ...
          <TabsContent value="overview" className="mt-4 space-y-4">
            <RelationshipOverviewPanel businessId={businessId} />
          </TabsContent>
