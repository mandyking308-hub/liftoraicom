...
export const ECOM_NAV = [
  { to: "/founder/ecommerce",            label: "Overview" },
  { to: "/founder/ecommerce/products",   label: "Products / SKUs" },
  { to: "/founder/ecommerce/inventory",  label: "Inventory" },
  { to: "/founder/ecommerce/orders",     label: "Orders" },
  { to: "/founder/ecommerce/fulfilment", label: "Fulfilment / Shipping" },
  { to: "/founder/ecommerce/returns",    label: "Returns" },
  { to: "/founder/ecommerce/suppliers",  label: "Suppliers" },
  { to: "/founder/ecommerce/settings",   label: "Settings" },
];

export function EcomLayout({ title, subtitle, children }: { title: string; subtitle?: string; children: ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span><span>E-commerce / Inventory / Fulfilment / Returns</span>
        </div>
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            ...
            <Badge variant="outline" className="bg-yellow-500/15 text-yellow-300 border-yellow-500/30 text-[10px]">
              <Lock size={9} className="mr-1" /> Supplier/ship/refund gated
            </Badge>
          </h1>
...
export function EcomStat({ label, value, hint, tone }: { label: string; value: number|string; hint?: string; tone?: "ok"|"warn"|"bad" }) {
