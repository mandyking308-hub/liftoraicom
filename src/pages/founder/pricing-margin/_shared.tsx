...
import { MARGIN_STATUS_META, type MarginStatus } from "@/lib/pricingMarginEngine";

export const PM_NAV = [
  { to: "/founder/pricing-margin", label: "Overview" },
  { to: "/founder/pricing-margin/products", label: "Products" },
  { to: "/founder/pricing-margin/businesses", label: "Businesses" },
  { to: "/founder/pricing-margin/discounts", label: "Discounts" },
  { to: "/founder/pricing-margin/breakeven", label: "Break-even" },
  { to: "/founder/pricing-margin/recommendations", label: "Recommendations" },
];

export function PMLayout({ title, subtitle, children, actions }: { title: string; subtitle?: string; children: ReactNode; actions?: ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <span>Pricing / Margin Engine</span>
        </div>
          ...
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              ...
              <Badge variant="outline" className="bg-yellow-500/15 text-yellow-300 border-yellow-500/30 text-[10px]">
                <Lock size={9} className="mr-1" /> Price changes gated
              </Badge>
            </h1>
...
export function PMSection({ title, description, children, actions }: { title: string; description?: string; children: ReactNode; actions?: ReactNode }) {
  return (
    <Card className="tech-card">
...
export function PMStat({ label, value, hint }: { label: string; value: ReactNode; hint?: string }) {
  return (
    <Card className="tech-card">
...
export function MarginStatusBadge({ status }: { status: MarginStatus }) {
  const m = MARGIN_STATUS_META[status];
