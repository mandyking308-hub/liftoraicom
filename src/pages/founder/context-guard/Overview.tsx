...
export default function CGOverview() {
  ...
  return (
    <CGLayout title="Multi-Business Context Guard"
      ...
      <CGSection title="Recent events" actions={<Link to="/founder/context-guard/events" className="text-xs text-primary hover:underline">All →</Link>}>
        {events.length === 0 ? (
