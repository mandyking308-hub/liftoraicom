...
import { MessageSquareHeart, ArrowLeft, ShieldAlert } from "lucide-react";

export const VOC_NAV = [
  { to: "/founder/customer-feedback",                  label: "Overview" },
  { to: "/founder/customer-feedback/signals",          label: "Signals" },
  { to: "/founder/customer-feedback/feature-requests", label: "Feature requests" },
  { to: "/founder/customer-feedback/testimonials",     label: "Testimonials" },
  { to: "/founder/customer-feedback/reviews",          label: "Reviews" },
  { to: "/founder/customer-feedback/churn-reasons",    label: "Churn reasons" },
  { to: "/founder/customer-feedback/insights",         label: "Insights" },
];

export function VocLayout({ title, subtitle, children }: { title: string; subtitle?: string; children: ReactNode }) {
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span><span>Voice of Customer</span>
        </div>
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            ...
            <Badge variant="outline" className="bg-yellow-500/15 text-yellow-300 border-yellow-500/30 text-[10px]">
              <ShieldAlert size={9} className="mr-1" /> Customer asks approval-gated
            </Badge>
          </h1>
