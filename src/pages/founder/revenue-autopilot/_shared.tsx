...
export const RA_NAV: { to: string; label: string }[] = [
  { to: "/founder/revenue-autopilot", label: "Overview" },
  { to: "/founder/revenue-autopilot/today", label: "Today" },
  { to: "/founder/revenue-autopilot/targets", label: "Targets" },
  { to: "/founder/revenue-autopilot/tasks", label: "Tasks" },
  { to: "/founder/revenue-autopilot/gaps", label: "Gaps" },
  { to: "/founder/revenue-autopilot/approvals", label: "Approvals" },
];
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          ...
          <span>/</span>
          <span>Revenue Autopilot Operating Loop</span>
        </div>
...
export function RAEmpty({ title, hint }: { title: string; hint?: string }) {
  return (
...
export function RAStat({ label, value, hint, tone = "default" }: { label: string; value: ReactNode; hint?: string; tone?: "default" | "good" | "warn" | "bad" }) {
