...
const CORE_AGENTS: Array<{ key: string; name: string; to: string; category: string }> = [
  ...
  { key: "onboarding_agent", name: "Onboarding Agent", to: "/founder/onboarding", category: "operations" },
  { key: "support_sla_agent", name: "Support SLA Agent", to: "/founder/support-sla", category: "support" },
