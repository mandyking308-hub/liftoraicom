...
export const RECONCILIATION_ROWS: ReconciliationRow[] = [
  ...
  { category: "Founder non-dynamic routes (router)", count: 69, notes: "Listed in DISCOVERED_FOUNDER_ROUTES; each represented in REGISTRY.", representation: "Master Index sections 0–14" },
...
export const REGISTRY: RegistryItem[] = [
  ...
  { name: "Business Manuals (12 canonical)", path: "/founder/business-manuals", section: "0", risk: "read-only", status: "valid", source: "App.tsx", notes: "Renders docs/business-manuals/** raw markdown." },
  { name: "GSM Outbound Infrastructure", path: "/founder/gsm-outbound", section: "0", risk: "external-integration", status: "valid", source: "App.tsx", notes: "Shared GSM sending estate: domains, mailboxes, Launch/Evergreen lanes. Read-only provider checks; no sends." },
  { name: "GHAT Outbound Estate", path: "/founder/ghat-outbound", section: "0", risk: "external-integration", status: "valid", source: "App.tsx", notes: "Dedicated Global Health Access Trust estate on globalhealthaccesstrust.org. Segregated from GSM capacity and lanes; no sends." },
  { name: "Education Commercial Layer", path: "/founder/education-commercial", section: "0", risk: "read-only", status: "valid", source: "App.tsx", notes: "Brand relevance, collision ownership, non-live campaign shells." },
