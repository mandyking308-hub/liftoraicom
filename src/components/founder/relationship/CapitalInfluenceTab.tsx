...
export {
  CAPITAL_LANE, CAPITAL_ROLE, BEST_VEHICLE, CONVERSATION_POSTURE, OUTREACH_STATUS,
  COMPLIANCE_BOUNDARY, SOURCE_PLATFORM, HNW_CONFIDENCE, PHILANTHROPY_CAUSE,
  DEAL_RELEVANCE, ALIGNMENT_QUALITY, PARK_REASON, NEXT_MOVE_OWNER,
} from "./capitalTaxonomy";
import {
  CAPITAL_LANE, CAPITAL_ROLE, BEST_VEHICLE, OUTREACH_STATUS,
  SOURCE_PLATFORM, HNW_CONFIDENCE, PHILANTHROPY_CAUSE,
  DEAL_RELEVANCE, ALIGNMENT_QUALITY, PARK_REASON, NEXT_MOVE_OWNER,
  DISCLOSURE, TRUST,
} from "./capitalTaxonomy";
