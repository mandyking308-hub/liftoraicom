    ...
    <div className="container">
      ...
      >
        ...
        <motion.h2 variants={fadeUp} custom={1} className="text-3xl sm:text-4xl lg:text-5xl font-bold">
          How Liftor Builds <span className="text-gradient">Intelligent Systems</span>
        </motion.h2>
      </motion.div>
      ...
      <div className="relative mt-16 hidden lg:block">
        {/* Connection line */}
        <div className="absolute top-8 left-[8%] right-[8%] h-px bg-border/50" />
        {/* Animated pulse */}
        <motion.div
          className="absolute top-[29px] w-3 h-3 rounded-full bg-primary/80 glow-sm -translate-y-1/2"
          style={{ left: "8%" }}
          animate={{ left: ["8%", "92%"] }}
        ...
        <div className="grid grid-cols-6 gap-10">
          {stages.map((s, i) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-primary/30 bg-primary/5 text-sm font-bold text-primary mb-5 relative z-10">
      ...
      <div className="lg:hidden mt-12 space-y-6">
        {stages.map((s, i) => (
          ...
          >
            <div className="shrink-0 inline-flex items-center justify-center w-12 h-12 rounded-full border border-primary/30 bg-primary/5 text-sm font-bold text-primary">
              {String(i + 1).padStart(2, "0")}
            </div>
            <div className="pt-1">
              <h3 className="text-sm font-semibold mb-1">{s.label}</h3>
