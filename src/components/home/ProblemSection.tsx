    ...
    <div className="container">
      <div className="grid gap-16 lg:grid-cols-2 items-center">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} custom={1} className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-6">
            Most Businesses Still Run on Manual Systems
          </motion.h2>
          <motion.div variants={fadeUp} custom={2} className="space-y-4 text-muted-foreground leading-relaxed mt-8">
        ...
        >
          <div className="aspect-square max-w-md mx-auto relative">
            ...
            {[
              ...
              >
                <div className="tech-card !p-0 w-16 h-16 flex items-center justify-center">
