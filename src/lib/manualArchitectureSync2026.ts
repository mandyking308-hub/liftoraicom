...
export const LIFTOR_MODULE_INDEX: ManualModuleEntry[] = [
  ...
  { route: "/founder/context-guard", module: "Context Guard", domain: "Governance", purpose: "Keeps AI context scoped to the selected business context.", scope: "platform", risk: "internal_only", tasks: ["safety"] },
