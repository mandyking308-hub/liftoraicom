...
export const DATA_ASSETS: DataAsset[] = [
  ...
  },
  {
    ...
    status: "live",
    system: "Liftor Supabase (production Relationship Intelligence)",
    repository: "mandyking308-hub/liftoraicom",
    sourceOfTruth: "public.relationship_intelligence_contacts (tag: education_customer_universe)",
    ...
    recordDefinition:
      "Education group/account → buyer role → named contact → current employer → email state (verified / reveal required / none on file) → business relevance → outreach hold/readiness",
    buyerPools: [
    ...
    locations: [
      "Supabase (current source of truth): public.relationship_intelligence_contacts — tag education_customer_universe",
      ...
      "Historical checkpoint: data/global-education-program-status-2026-08-22.json",
      "Historical checkpoint: data/global-education-buyers-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-isp-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-gems-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-globeducate-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-dukes-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-taaleem-uae-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-sabis-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-gulf-batch-2-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-buyers-premium-batch-3-2026-08-22.jsonl",
      "Historical checkpoint: data/global-education-research-entity-exclusions-2026-08-22.jsonl",
      "Import route: supabase/functions/ri-upsert-import/index.ts",
      "Recovery sync: supabase/functions/apollo-education-recovery/index.ts",
    ...
    historicalStats: [
      { label: "Checkpoint groups seeded", value: 22, note: "Original saved GitHub checkpoint, 22 Aug 2026 — not current holdings" },
      { label: "Checkpoint contacts saved", value: 146, note: "Original saved GitHub checkpoint, 22 Aug 2026 — superseded by live production counts" },
      { label: "Checkpoint verified emails", value: 109, note: "Same 109 verified work emails preserved in production" },
      { label: "Checkpoint held rows", value: 37, note: "Held, not verified, at the 22 Aug 2026 checkpoint" },
      { label: "Original target groups", value: 120, note: "Historical target only — not a current actual" },
      { label: "Original target contacts", value: 2500, note: "Historical target — exceeded by the recovered production universe" },
    ],
    lastReviewed: "2026-08-24",
    retentionRule: "Preserve missing, stale, mismatched and unverified rows in a held state; never discard research merely because it is not send-ready. Historical snapshot counts must never overwrite live production counts.",
